...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    final String ANDROID_APP_PLAY_URL = "https://play.google.com/store/apps/details?id=funpun.org";
    ...
    public void onHeaderClick(PreferenceActivity.Header header, int position) {
        ...
        if (header.id == R.id.share) {
            ...
            sharingIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.title_invite_friend));
            sharingIntent.putExtra(Intent.EXTRA_TEXT, ANDROID_APP_PLAY_URL);

            startActivity(Intent.createChooser(sharingIntent, getResources().getString(R.string.title_invite_friend)));
